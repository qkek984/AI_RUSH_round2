...
import torch
from models.utils.nest_resnet import ResNet, Bottleneck
...
def resnest50(pretrained=True, root='~/.encoding/models', onehot=1, onehot2=0, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=32, avg_down=True,
                   avd=True, avd_first=False,
                   onehot=onehot, onehot2=onehot2, name="nest50", **kwargs)
    if pretrained:
